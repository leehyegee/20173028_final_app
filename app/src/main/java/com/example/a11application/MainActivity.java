package com.example.a11application;
    ...
    public void InitalLizeListner()
    {
        callbackMethon = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
                ...
                editText.setText("https://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=3348a61276e25d5c3e6e518c047d6ab1&&targetDt="+date);
            }
        };
    }
